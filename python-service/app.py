...
def analyze_bti():
    ...
    try:
        ...
        - Указывай точку только если объект РЕАЛЬНО СУЩЕСТВУЕТ на плане этого помещения.
        - Если в помещении НЕТ ОКНА (как часто бывает в санузлах или коридорах), ЗАПРЕЩЕНО писать "У окна". 
        - Используй альтернативы: "В центре помещения", "У дальней стены", "Напротив входа", "У сантехники".
        - Мебель по-прежнему запрещена.
