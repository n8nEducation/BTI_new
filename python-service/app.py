...
На большинстве планов БТИ названия помещений НЕ написаны — только цифры (номер и площадь). В этом случае ВСЕ помещения называются "Помещение [id]". Слова "Кухня", "Санузел", "Коридор", "Жилая" и любые другие названия допустимы ТОЛЬКО если они буквально напечатаны на плане внутри или рядом с контуром помещения. Если ты не видишь напечатанное слово — пишешь "Помещение [id]", без исключений.
